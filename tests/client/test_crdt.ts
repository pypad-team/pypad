...
describe("crdt", () => {
    ...
    describe("remoteInsert", () => {
        it("inserts character into start of document", () => {
            ...
            client.crdt.document = [
                [
                    ...
                    { id: [{ digit: 20, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" },
                    { id: [{ digit: 30, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" },
                    { id: [{ digit: 40, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" }
                ]
            ];
            const ch = { id: [{ digit: 1, peer: "1" }], uuid: client.uuid, counter: 0, data: "b" };
        ...
        it("inserts character into end of document", () => {
            ...
            const ch = { id: [{ digit: 50, peer: "1" }], uuid: client.uuid, counter: 0, data: "b" };
        ...
        it("inserts character into end of line", () => {
            ...
            client.crdt.document = [
                ...
                [
                    { id: [{ digit: 60, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" },
                    { id: [{ digit: 70, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" },
                    { id: [{ digit: 80, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" },
                    { id: [{ digit: 90, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" }
                ]
            ];
            const ch = { id: [{ digit: 45, peer: "1" }], uuid: client.uuid, counter: 0, data: "b" };
        ...
        it("inserts character into start of line", () => {
            ...
            const ch = { id: [{ digit: 55, peer: "1" }], uuid: client.uuid, counter: 0, data: "b" };
        ...
        it("inserts newline character", () => {
            ...
            const ch = { id: [{ digit: 25, peer: "1" }], uuid: client.uuid, counter: 0, data: "\n" };
        ...
        it("inserts multiple newline characters", () => {
            ...
            const ch1 = { id: [{ digit: 50, peer: "1" }], uuid: client.uuid, counter: 0, data: "\n" };
            const ch2 = { id: [{ digit: 60, peer: "1" }], uuid: client.uuid, counter: 0, data: "\n" };
        ...
        it("inserts newline character into end of line", () => {
            ...
            const ch = { id: [{ digit: 55, peer: "1" }], uuid: client.uuid, counter: 0, data: "\n" };
        ...
        it("inserts multiple characters into document", () => {
            ...
            const ch1 = { id: [{ digit: 24, peer: "1" }], uuid: client.uuid, counter: 0, data: "\n" };
            const ch2 = { id: [{ digit: 74, peer: "1" }], uuid: client.uuid, counter: 0, data: "\n" };
            const ch3 = { id: [{ digit: 26, peer: "1" }], uuid: client.uuid, counter: 0, data: "b" };
            const ch4 = { id: [{ digit: 76, peer: "1" }], uuid: client.uuid, counter: 0, data: "b" };
    ...
    describe("remoteDelete", () => {
        it("deletes chracter from start of document", () => {
            ...
            const ch = { id: [{ digit: 10, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" };
        ...
        it("deletes character from end of document", () => {
            ...
            const ch = { id: [{ digit: 40, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" };
        ...
        it("deletes character from end of line", () => {
            ...
            client.crdt.document = [
                ...
                [
                    { id: [{ digit: 60, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" },
                    { id: [{ digit: 70, peer: "1" }], uuid: client.uuid, counter: 0, data: "b" },
                    { id: [{ digit: 80, peer: "1" }], uuid: client.uuid, counter: 0, data: "b" },
                    { id: [{ digit: 90, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" }
                ]
            ];
            const ch = { id: [{ digit: 40, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" };
        ...
        it("deletes character from start of line", () => {
            ...
            const ch = { id: [{ digit: 60, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" };
        ...
        it("deletes newline character", () => {
            ...
            const ch = { id: [{ digit: 50, peer: "1" }], uuid: client.uuid, counter: 0, data: "\n" };
        ...
        it("deletes multiple characters from document", () => {
            ...
            const ch1 = { id: [{ digit: 50, peer: "1" }], uuid: client.uuid, counter: 0, data: "\n" };
            const ch2 = { id: [{ digit: 40, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" };
            const ch3 = { id: [{ digit: 60, peer: "1" }], uuid: client.uuid, counter: 0, data: "a" };
