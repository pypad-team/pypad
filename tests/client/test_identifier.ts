...
describe("generateIdentifier", () => {
    ...
    it("constructs an identifier between short identifiers with equivalent digits", () => {
        const id1 = [{ digit: 1, peer: 1 }];
    ...
    it("constructs an identifier between long identifiers with equivalent digits", () => {
        const id1 = [
            { digit: 1, peer: 1 },
            { digit: 1, peer: 1 }
        ];
    ...
    it("constructs an identifier between long identifiers with equivalent digits and peers", () => {
        const id1 = [
            { digit: 1, peer: 1 },
            { digit: 1, peer: 1 }
        ];
